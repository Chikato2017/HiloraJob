<template>
  <header class="site-header" id="header">
    <div class="nav-container">
      <router-link to="/employer"  class="brand-logo" id="brand-logo">
      ...
      <div class="nav-actions">
        <!--<button class="btn-add"><img src="../../assets/add_circle_two.svg" alt="">Add Job</button>-->
        <router-link to="/employer/company-profile">
